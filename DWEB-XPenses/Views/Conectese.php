            ...
            <div class="col-lg-6 d-flex flex-column align-items-center">
                <div class="card shadow p-4 w-75">
                    ...
                    <form action="../Controller/UserController.php?action=login" method="POST">
                        ...
                        <button type="submit" class="btn w-100">FAZER LOGIN</button>
                    </form>
                    <div class="text-center mt-3">
                        <a href="./recuperacao.php" class="text-muted">Esqueceu a senha? Recuperar Senha</a>
                    </div>
                </div>
            </div>
        </div>
