    ...
    <div class="container-fluid analise d-flex flex-column min-vh-100">
        <div class="row flex-grow-1">
            ...
            <div class="bloco col-lg-10 p-4">
                <h2 class="text-center text-success">Categorias</h2>

                <form class="container">
                    <div class="row text-center mb-2">
                        <div class="col-4 fw-bold">Nome da Categoria</div>
                        <div class="col-4 fw-bold">Descrição</div>
                        <div class="col-2 fw-bold">Peso (1 a 5)</div>
                        <div class="col-2"></div>
                    </div>
                    <!-- Category Items -->
                    ...
                    <div class="row mb-2">
                        <div class="col-2 d-flex align-items-center">
                            <button class="btn edit" id="addCategoryBtn" type="button">+</button>
                        </div>
                    </div>
