// exemplo de dados de despesas
const mockExpensesData = {
    "2024-01": [{ valor: 1500, categoria: 'Casa'}],
    "2024-02": [{ valor: 300, categoria: 'Alimentação'},{valor: 250.00, categoria: 'Casa'}],
...
// Função para carregar as despesas de um mês específico
function loadExpenses(date) {
    currentExpenses = mockExpensesData[date] || [];
    renderExpenses();
}
...
function renderExpenses() {
    ...
    currentExpenses.forEach((expense, index) => {
        ...
        expenseRow.innerHTML = `
            <div class="col-4"><input type="number" class="form-control" value="${expense.valor}"></div>
    ...
    // Adicionando botão para adicionar nova despesa
...
function addExpense() {
    currentExpenses.push({ valor: 0, categoria: ''});
    renderExpenses();
}
...
//Função para salvar as alterações de uma despesa
...
// Event listener para carregar as despesas do mês selecionado
...
// adicionar evento de clique no botão de adicionar despesa
