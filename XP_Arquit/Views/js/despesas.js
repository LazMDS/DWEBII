...
const mockExpensesData = {
    "2024-01": [{ descricao: 'Aluguel', categoria: 'Casa', valor: 1500 }],
    "2024-02": [{ descricao: 'Supermercado', categoria: 'Alimentação', valor: 300 },{descricao: 'Luz', categoria: 'Casa', valor: 250.00}],
    // Adicionar mais despesas para outros meses
};
...
function renderExpenses() {
    ...
    // Adicionar botão para adicionar nova despesa
...
// Função para salvar uma despesa editada
...
// Event listener para mudar o mês selecionado
...
// Adicionar evento para adicionar despesa
